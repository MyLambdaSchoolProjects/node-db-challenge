...
- [x] Explain the difference between `Relational Databases` and `SQL`.
 Relational databases are a collection to tables that have data sets related to it and may reference data from another table. SQL stands for Structured Query Language and is used in th creation of databases.

- [x] Why do tables need a `primary key`?
 So the database is able to uniquely identify a given record
